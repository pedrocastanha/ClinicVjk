          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Com anos de experiência, Emily Vujanski é especialista em 
            ...
            <div className="space-y-6">
              <p className="text-lg text-gray-700 leading-relaxed">
                Formada em Nutrição & Estética pela Unicesumar de Maringá, dedica-se a proporcionar tratamentos 
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Mais de 200 pacientes atendidos</p>
                </div>
              </div>
